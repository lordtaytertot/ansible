...
jq 'del(.roots.bookmark_bar.children[0].children[0,1,2,4],.roots.bookmark_bar.children[31:],.roots.synced.children,.sync_metadata)' ${PERSONAL_SOURCE_FILE} > ${PERSONAL_APOLLO_PATH}
